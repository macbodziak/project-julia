...
// 6. create an entry in the enum StatusEffectType and add this type to the switch statement
//    in ReceiveStatusEffect and RemoveStatusEffect in the StatusEffectController
// </summary>
